...
import com.example.hotel_booking_be_v1.exception.RoleAlreadyExistException;
import com.example.hotel_booking_be_v1.model.Role;
import com.example.hotel_booking_be_v1.model.User;
import com.example.hotel_booking_be_v1.service.IRoleService;
...
public class RoleController {
    ...
    public User removeUserFromRole(@RequestParam("userId") Long userId,
                                   @RequestParam("roleId")Long roldId){
        return roleService.removeUserFromRole(userId,roldId);
    }
